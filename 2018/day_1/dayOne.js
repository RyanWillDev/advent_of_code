...
function partOne() {
  return parse().reduce((total, current) => total + current, 0);
}
...
console.log(`The answer to Part 1: ${partOne()} \n`);
const a = partTwoImperative();

console.time('Time to solve Part 2: ');
console.log(`The answer to Part 2: ${a[0]}. It took ${a[1]} loops to find it.`);
console.timeEnd('Time to solve Part 2: ');

console.log('\n');

console.log(
  'Calculating the answer using recursion and trampoline function.\nMight wanna go grab a coffee : )\n'
);

console.time(
  'Time to solve Part 2 recursively with the dataset [3, 3, 4, -2, -4] only'
);
console.log(
  `The answer to Part 2 with the data set [3, 3, 4, -2, -4] only: ${partTwoTrampoline()}`
);
console.timeEnd(
  'Time to solve Part 2 recursively with the dataset [3, 3, 4, -2, -4] only'
);
